...
import com.avazu.testplugin.TestViewPager.ui.LoopViewPager;
import com.avazu.testplugin.TestViewPager.recyclerview.SnappingSwipingViewBuilder;
import com.avazu.testplugin.TestViewPager.recyclerview.SnappyLinearLayoutManager;
import com.avazu.testplugin.TestViewPager.recyclerview.SwipeGestureHelper;

import java.util.ArrayList;
import java.util.Collections;
import java.util.List;

public class TestRecycleActivity extends AppCompatActivity implements SwipeGestureHelper.OnSwipeListener{
...
//        initRecycleView();
    ...
    public void initLoopViewPager(){
        ...
        for(int i = 0; i < 20; i ++) {
            fgList.add(TestViewPagerFragment.getInstance(i));
        }

        LoopViewPager vp = (LoopViewPager)findViewById(R.id.test_loopViewPager);
    ...
    public void initRecycleView(){
        RelativeLayout rl = (RelativeLayout) findViewById(R.id.activity_test_recycle);
